...
$course_id = $_GET['course_id'] ?? exit('No course ID specified');

// Fetch all feedback for the selected course
$result = $conn->prepare("SELECT Feedback.*, Users.first_name, Users.last_name FROM Feedback JOIN Users ON Feedback.user_id = Users.user_id WHERE Feedback.course_id = ?");
